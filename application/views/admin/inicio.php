                                        ...
                                        <div class="col-xxl-6 col-lg-4 col-sm-6">
                                            <div class="card card-bordered product-card">
                                                ...
                                                <ul class="product-tags">                                 
                                                    ...
                                                    <h3 class="product-title">Modulo Inventario de Productos</h3>
                                                </div>
                                            </div>
                                        </div><!-- .col -->
                                        <div class="col-xxl-6 col-lg-4 col-sm-6">
                                            <div class="card card-bordered product-card">
                                                ...
                                                <div class="card-inner text-center">
                                                    <ul class="product-tags">
                                                    <li><a href="<?php echo base_url() ?>admin/ventas" class="btn btn-primary"><span style="color: white;">Acceder</span></a></li>
                                                    </ul>
                                                    <h3 class="product-title">Modulo de Ventas</h3>
